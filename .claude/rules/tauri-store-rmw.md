...
`C:\Users\Andrea\AppData\Roaming\com.pane-management.app\settings.json` holds multiple unrelated top-level keys: `companion.bearer_token`, `companion.hook_secret`, `companion.ntfy_topic`, `project_meta`, `pane_presets`, `pane_assignments`, `session_order`, `pinned_order`, `session_names`, `terminal_settings`, `error_log`, plus others.
